...
class TurtlesimVelocityTransformer : public rclcpp::Node {
 ...
 private:
  ...
  rclcpp::Subscription<geometry_msgs::msg::Twist>::SharedPtr
      cmd_vel_sub_;  ///< Subscriber to normalized velocity commands in world frame
  rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr
      pose_sub_;  ///< Subscriber to the robot's latest pose
  rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr
      pub_;  ///< Publisher to turtlesim velocity commands (body frame)

  geometry_msgs::msg::PoseStamped::SharedPtr
      latest_pose_;  ///< Storage for latest pose to use in velocity transformation
};
