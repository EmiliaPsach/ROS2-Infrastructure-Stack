 ...
 *
 * Initializes subscribers for /cmd_vel (world frame velocity commands) and /cur_pose (latest robot
 * pose), and a publisher for turtlesim's /turtle1/cmd_vel (body frame velocity commands).
 */
TurtlesimVelocityTransformer::TurtlesimVelocityTransformer()
    : Node("turtlesim_velocity_transformer") {
 ...
 */
void TurtlesimVelocityTransformer::poseCallback(
...
/**
 * @brief Velocity command callback transforms and scales world frame velocities to body frame
 * velocities.
 *
